...
if __name__ == '__main__':
    ...
    # 使用多层感知器 (MLP) 进行模型训练
    model = MLPClassifier(hidden_layer_sizes=(100, 50), activation='tanh', alpha=0.001, max_iter=200, random_state=42)
    ...
    np.savetxt('results_MLP.txt', result, delimiter=', ', fmt='%s')
